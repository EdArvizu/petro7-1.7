function CPreloader() {
    ...
    this.attachSprites = function () {
        ...
        oBg.graphics.beginFill("white").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        ...
        _oIcon.y = CANVAS_HEIGHT/2 - 90;
        _oContainer.addChild(_oIcon);

        _oIconMask = new createjs.Shape();
        _oIconMask.graphics.beginFill("").drawRoundRect(_oIcon.x - 150, _oIcon.y - 150, 280, 280, 10);
        ...
        _oMaskPreloader.graphics.beginFill("").drawRect(_oProgressBar.x, _oProgressBar.y, 1, _iMaskHeight);
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/1.2, oSprite, TEXT_PRELOADER_CONTINUE, "Lab Grotesque", "white", "bold "+ 50, _oContainer);        
    ...
    this.refreshLoader = function (iPerc) {
        ...
        _oMaskPreloader.graphics.beginFill("").drawRect(_oProgressBar.x, _oProgressBar.y, iNewMaskWidth, _iMaskHeight);
    };
